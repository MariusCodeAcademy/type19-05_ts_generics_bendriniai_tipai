...
const req2: HttpRequest = {
  ...
  body: {
    image:
      'https://i.pinimg.com/474x/67/0a/1d/670a1d06e7bff426ec343e8c06c93ca5--crazy-faces-strange-people.jpg',
  },
  method: 'POST',
};
...
console.group('Literal types - užduotys');
{
  ...
  );
  {
    ...
    const oneOfCities: GermanCity = 'Hamburg';
    console.log('oneOfCities ===', oneOfCities);
  }
  console.groupEnd();
